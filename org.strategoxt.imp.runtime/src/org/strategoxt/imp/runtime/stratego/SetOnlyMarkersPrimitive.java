...
public class SetOnlyMarkersPrimitive extends AbstractPrimitive {

	public SetOnlyMarkersPrimitive() {
		super("SSL_EXT_set_only_markers", 0, 1);
	}
	...
	public boolean call(IContext env, Strategy[] svars, IStrategoTerm[] tvars)
		...
		observer.updateMarkers(resource, env.current());
