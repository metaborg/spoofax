...
public class MetaBorgGeneric<P, A, T> extends MetaBorg {
     ...
     */
    public MetaBorgGeneric(MetaborgModule module, IModulePluginLoader loader) throws MetaborgException {
        super(module, loader);
        ...
        this.syntaxService = injector.getInstance(Key.get(new TypeLiteral<ISyntaxService<P>>() {}));
        this.analysisService = injector.getInstance(Key.get(new TypeLiteral<IAnalysisService<P, A>>() {}));
        this.transformService = injector.getInstance(Key.get(new TypeLiteral<ITransformService<P, A, T>>() {}));

        this.builder = injector.getInstance(Key.get(new TypeLiteral<IBuilder<P, A, T>>() {}));

        this.parseResultProcessor = injector.getInstance(Key.get(new TypeLiteral<IParseResultProcessor<P>>() {}));
        this.analysisResultProcessor =
            injector.getInstance(Key.get(new TypeLiteral<IAnalysisResultProcessor<P, A>>() {}));

        this.actionService = injector.getInstance(IActionService.class);
        this.menuService = injector.getInstance(IMenuService.class);

        this.tracingService = injector.getInstance(Key.get(new TypeLiteral<ITracingService<P, A, T>>() {}));

        this.categorizerService = injector.getInstance(Key.get(new TypeLiteral<ICategorizerService<P, A>>() {}));
        this.stylerService = injector.getInstance(Key.get(new TypeLiteral<IStylerService<P, A>>() {}));
        this.hoverService = injector.getInstance(Key.get(new TypeLiteral<IHoverService<P, A>>() {}));
        this.resolverService = injector.getInstance(Key.get(new TypeLiteral<IResolverService<P, A>>() {}));
        this.outlineService = injector.getInstance(Key.get(new TypeLiteral<IOutlineService<P, A>>() {}));
     ...
     *             When loading plugins or dependency injection fails.
     */
    public MetaBorgGeneric(MetaborgModule module) throws MetaborgException {
     ...
     *             When loading plugins or dependency injection fails.
     */
    public MetaBorgGeneric(IModulePluginLoader loader) throws MetaborgException {
     ...
     *             When loading plugins or dependency injection fails.
     */
    public MetaBorgGeneric() throws MetaborgException {
