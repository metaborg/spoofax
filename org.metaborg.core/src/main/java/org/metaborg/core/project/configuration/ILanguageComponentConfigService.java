...
public interface ILanguageComponentConfigService {
     ...
     */
    @Nullable
    ILanguageComponentConfig get(ILanguageComponent languageComponent) throws IOException;
     ...
     */
    @Nullable
    ILanguageComponentConfig get(FileObject rootFolder) throws IOException;
