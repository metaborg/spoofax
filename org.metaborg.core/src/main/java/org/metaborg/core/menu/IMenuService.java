...
public interface IMenuService {
    ...
    // /**
    // * Gets a named action in given language implementation. Actions are nested inside menus, which can be retrieved
    // by
    ...
    // */
    // public abstract @Nullable IAction nestedAction(ILanguageImpl language, List<String> names) throws
    // MetaborgException;
    //
    // /**
