...
public class ScopeGraphMultiFileAnalyzer extends AbstractConstraintAnalyzer<IMultiFileScopeGraphContext>
        implements ISpoofaxAnalyzer {

    private static final ILogger logger = LoggerUtils.logger(ScopeGraphMultiFileAnalyzer.class);

    public static final String name = "scopegraph-multifile";

    private final ISpoofaxUnitService unitService;

    @Inject public ScopeGraphMultiFileAnalyzer(final AnalysisCommon analysisCommon,
