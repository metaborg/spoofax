...
public interface IStrategoRuntimeService {
    /**
     * Obtain a new {@link HybridInterpreter} for given {@link IContext}. The produced interpreter is based on
     * an internally cached interpreter instance for the language in given context. If such a cache does not
     ...
     *         {@link StrategoFacet#ctreeFiles()} and {@link StrategoFacet#jarFiles()} respectively are loaded
