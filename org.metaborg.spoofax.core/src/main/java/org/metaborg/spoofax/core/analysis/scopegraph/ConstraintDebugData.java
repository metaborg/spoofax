...
public class ConstraintDebugData {
    ...
    @Override public String toString() {
        ...
        sb.append("Analysis time : ");
        sb.append(Duration.ofNanos(totalTime).toMillis() / 1000.0);
        sb.append("s\n");
        sb.append(" * collect    : ");
        sb.append(Duration.ofNanos(collectionTime).toMillis() / 1000.0);
        sb.append("s\n");
        sb.append(" * solve      : ");
        sb.append(Duration.ofNanos(solverTime).toMillis() / 1000.0);
        sb.append("s\n");
        sb.append(" * finalize   : ");
        sb.append(Duration.ofNanos(finalizeTime).toMillis() / 1000.0);
        sb.append("s\n");
        return sb.toString();
    }
