...
import org.metaborg.meta.nabl2.spoofax.primitives.SG_get_ast_analysis;
...
import org.metaborg.meta.nabl2.spoofax.primitives.SG_get_resource_analysis;
...
import org.metaborg.meta.nabl2.spoofax.primitives.SG_show_control_flow_graph;
...
public class SpoofaxModule extends MetaborgModule {
    ...
    @Override protected void bindAnalysis() {
        ...
        bindPrimitive(spoofaxScopeGraphLibrary, SG_show_control_flow_graph.class);
