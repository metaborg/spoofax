...
public class MenuService implements IMenuService {
    ...
    // }
    //
    // @Override public @Nullable ActionContribution nestedActionContribution(ILanguageImpl language, List<String>
    // names)
    // throws MetaborgException {
    ...
    // if(rest.isEmpty() && item instanceof IMenuAction) {
    // final IMenuAction menuAction = (IMenuAction) item;
    // return Iterables2.singleton(menuAction.action());
    ...
    // if(name.equals(item.name()) && item instanceof IMenuAction) {
    // final IMenuAction menuAction = (IMenuAction) item;
    // return Iterables2.singleton(menuAction.action());
    // } else if(item instanceof IMenu) {
    // final IMenu menu = (IMenu) item;
