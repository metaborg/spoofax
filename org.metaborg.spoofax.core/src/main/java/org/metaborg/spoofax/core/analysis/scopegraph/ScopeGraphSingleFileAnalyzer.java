...
public class ScopeGraphSingleFileAnalyzer extends AbstractConstraintAnalyzer<ISingleFileScopeGraphContext>
        implements ISpoofaxAnalyzer {

    public static final ILogger logger = LoggerUtils.logger(ScopeGraphSingleFileAnalyzer.class);

    public static final String name = "scopegraph-singlefile";

    private final ISpoofaxUnitService unitService;

    @Inject public ScopeGraphSingleFileAnalyzer(final AnalysisCommon analysisCommon,
