...
public class SpoofaxNature implements IProjectNature {
    ...
    /**
     * Adds this nature to given project. Does nothing if this nature has already been added to the project. Adding this
     * nature also adds a {@link SpoofaxProjectBuilder} to the project.
     * 
     * @param project
    ...
    /**
     * Removes this nature from given project. Does nothing if the nature has not been added to the project. Removing
     * this nature also removes the {@link SpoofaxProjectBuilder} from the project.
     * 
     * @param project
