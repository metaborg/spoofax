...
public class Sdf2TableLegacy extends SpoofaxBuilder<Sdf2TableLegacy.Input, OutputPersisted<File>> {
    ...
    public static SpoofaxBuilderFactory<Input, OutputPersisted<File>, Sdf2TableLegacy> factory =
        SpoofaxBuilderFactoryFactory.of(Sdf2TableLegacy.class, Input.class);
    ...
    public static
        BuildRequest<Input, OutputPersisted<File>, Sdf2TableLegacy, SpoofaxBuilderFactory<Input, OutputPersisted<File>, Sdf2TableLegacy>>
        request(Input input) {
