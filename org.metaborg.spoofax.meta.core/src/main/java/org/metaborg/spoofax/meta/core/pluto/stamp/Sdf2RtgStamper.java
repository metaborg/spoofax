...
public class Sdf2RtgStamper implements Stamper {
    ...
    private BuildRequest<ParseFile.Input, OutputPersisted<IStrategoTerm>, ?, ?> parseSdf;


    public Sdf2RtgStamper(BuildRequest<ParseFile.Input, OutputPersisted<IStrategoTerm>, ?, ?> parseSdf) {
