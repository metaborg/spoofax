...
public class ForceOnSaveFile extends Builder<SpoofaxBuildContext, Path, SimpleCompilationUnit> {
	...
	protected Path persistentPath(Path input) {
		...
		return context.basePath("${include}/build.forceOnSave." + relname + ".dep");
	}
...
//				break;
		case "sdf3":
			...
			RelativePath genPP = FileCommands.replaceExtension(context.basePath("${pp}/" + sdf3.getRelativePath()), "str");
