...
public class CompileJavaCode extends Builder<SpoofaxBuildContext, Void, SimpleCompilationUnit> {

	public static BuilderFactory<SpoofaxBuildContext, Void, SimpleCompilationUnit, CompileJavaCode> factory = new BuilderFactory<SpoofaxBuildContext, Void, SimpleCompilationUnit, CompileJavaCode>() {
		@Override
		public CompileJavaCode makeBuilder(SpoofaxBuildContext context) { return new CompileJavaCode(context); }
	};
	
	public CompileJavaCode(SpoofaxBuildContext context) {
		super(context);
	}
